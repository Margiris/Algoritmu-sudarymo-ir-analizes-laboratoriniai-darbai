...
namespace TestSorting
{
    ...
    public class SelectionSortTest
    {
        ...
        /// <summary>
        /// Test if selection sort implementation works and sorts numbers in ArrayRAM correctly.
        /// </summary>
        ...
        /// <summary>
        /// Test if selection sort implementation works and sorts numbers in ArrayDisk correctly.
        /// </summary>
        /// <param name="length">Length of the list to sort</param>
        [TestMethod]
        [DataRow(1)]
        ...
        public void TestArrayDiskSort(int length)
        {
            ...
            System.Array.Sort(arrSource1);
            SelectionSort.Sort(arrSource2, a, t, count, pref);

            Assert.AreEqual(-1, Util.FindArraysDifferenceIndex(arrSource1, arrSource2));
        }

        /// <summary>
        /// Test if selection sort implementation works and sorts numbers in LinkedListRAM correctly.
        /// </summary>
        /// <param name="length">Length of the list to sort</param>
        [TestMethod]
        [DataRow(1)]
        ...
        /// <summary>
        /// Test if selection sort implementation works and sorts numbers in LinkedListDisk correctly.
        /// </summary>
        /// <param name="length">Length of the list to sort</param>
        [TestMethod]
        [DataRow(1)]
